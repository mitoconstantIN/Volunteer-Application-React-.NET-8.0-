...
import { FormErrorMessage, Button, Flex, FormControl, FormLabel, Heading, Input, Stack, Image, Divider, Text } from '@chakra-ui/react';
    ...
    <Stack minH={"100vh"} direction={{ base: "column", md: "row" }}>
      <Flex p={8} flex={1} align={"center"} justify={"center"}>
        <Stack spacing={4} w={"full"} maxW={"md"} as="form" onSubmit={handleSubmit(onSubmit)}>
          <Heading fontSize={"2xl"}>Welcome Volunteer!</Heading>
